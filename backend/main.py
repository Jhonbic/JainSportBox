...
if engine.url.get_backend_name() == "sqlite":
    ...
    _migraciones = [
        ...
        "ALTER TABLE pagos ADD COLUMN numero_ingresos INTEGER",
        "ALTER TABLE pagos ADD COLUMN fecha_inicio DATE",
        "ALTER TABLE usuarios ADD COLUMN membresia_inicio DATE",
...
if engine.url.get_backend_name() != "sqlite":
    _cols_pg = [
        ...
        "ALTER TABLE pagos ADD COLUMN IF NOT EXISTS numero_ingresos INTEGER",
        "ALTER TABLE pagos ADD COLUMN IF NOT EXISTS fecha_inicio DATE",
        "ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS membresia_inicio DATE",
